...
تكتب الدالتان `before_data` و`after_data` داخل المعاملة نفسها. نجح تحقق هذه البنية على Staging في 56 مطالبة، لكنها لا تعد إنتاجية قبل الدمج والنسخة الاحتياطية وتحقق الإنتاج.
