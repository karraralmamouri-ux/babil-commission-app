...
> الحالة الحالية: نموذج أولي منشور. المصادقة وملفات المستخدمين مرتبطة بـSupabase، وبيانات التشغيل الافتراضية ما زالت محلية في المتصفح. توجد معاينة اختيارية للبيانات المركزية للقراءة فقط؛ الكتابة المركزية لم تُفعّل في الواجهة بعد. راجع [حالة المشروع](docs/PROJECT_STATUS.md) و[تدقيق خط الأساس](docs/BASELINE_AUDIT.md) قبل أي تعديل.
